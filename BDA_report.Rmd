...
**探索religion(宗教信仰)和religion_freq(参加宗教的频繁程度)与happiness的关联**  
...
**探索以下生活方式socialize(社交的频率),relax(休闲放松的频率),learn(学习充电的频率)与happiness的关联**
...
**探索住房面积(floor_area)与happiness的关联**
